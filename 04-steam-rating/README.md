...
我想验证一个听起来很合理的假设:**能不能靠一款游戏的公开信息(价格、平台、语言、简介……),提前预测出它上线后的口碑?** 做完之后我的结论是:很难,而且"很难"这件事本身就是最有价值的发现。
...
这是作品集里唯一一个"指标不好看"的项目,我依然放进来,因为它教会我一件对产品经理很重要的事:**一个诚实的负面结论,比一个粉饰过的正面结论有用。**

如果我在汇报里只说"我做了个模型预测游戏评分",那是在误导人。真实情况是:好评率这个东西,靠元数据预测的天花板本来就很低。我能拿出证据说清楚这一点——
...
对一个 PM 来说,能提前说出"这个方向做不出高精度模型,原因是关键变量没进数据集",比硬把 R² 从 0.07 调到 0.15 更有价值。后者我也做了,但我不会假装它解决了问题。
